...
<div class="footer py-5">
    <div class="container">
            ...
            <div class="follow-us d-flex align-items-center gap-4">
                ...
                <div class="sosmed d-flex align-items-center gap-3">
                   <h4>
                    ...
                    <h4>
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="white" d="m10 15l5.19-3L10 9zm11.56-7.83c.13.47.22 1.1.28 1.9c.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 4.83c-.25.9-.83 1.48-1.73 1.73c-.47.13-1.33.22-2.65.28c-1.3.07-2.49.1-3.59.1L12 19c-4.19 0-6.8-.16-7.83-.44c-.9-.25-1.48-.83-1.73-1.73c-.13-.47-.22-1.1-.28-1.9c-.07-.8-.1-1.49-.1-2.09L2 12c0-2.19.16-3.8.44-4.83c.25-.9.83-1.48 1.73-1.73c.47-.13 1.33-.22 2.65-.28c1.3-.07 2.49-.1 3.59-.1L12 5c4.19 0 6.8.16 7.83.44c.9.25 1.48.83 1.73 1.73"/></svg>
                        </a>
                    </h4>
                    <h4>
                        <a href="">
        ...
        <div class="row text-white justify-content-sm-between justify-content-center">
            ...
            <div class="col-md-4 col-sm-7 col-10 my-md-0 my-3">
                ...
                <div class="email-footer my-3 d-flex align-items-start gap-3">
                    ...
                    <div class="isi">
                        <p>info@satstation.co.id</p>
                        <p>sales@satstation.co.id</p>
                    </div>
                </div>
                <div class="alamat-footer my-3 d-flex align-items-start gap-3">
                    ...
                    <div class="isi">
                        <p>Gedung Graha KSA, Jl. Jelawat,
                            Sidomulyo, Kec. Samarinda Ilir,
        ...
        <div class="footer-middle row align-items-start">
            <div class="col-lg-2 col-12 my-lg-0 my-1">
                <h5 class="text-white" style="white-space: nowrap;">Klien Kami :</h5>
            </div>
            <div class="col-lg-10 col-12 my-lg-0 my-1">
                <div class="row">
                    <div class="col-md-2 col-sm-3 col-4 my-2 column-klien" >
                        <img src="{{asset('../Images/klien.png')}}" alt="">
                    </div>
                    <div class="col-md-2 col-sm-3 col-4 my-2 column-klien" >
                        <img src="{{asset('../Images/klien.png')}}" alt="">
                    </div>
